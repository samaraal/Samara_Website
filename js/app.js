...
(function(){
  ...
  const HOME_TRANSLATIONS={
    ...
    'Safe. Respectful. Reassuring.':'பாதுகாப்பு. மரியாதை. நம்பிக்கை.','A Home Where Medical Excellence Meets Compassionate Living, Supported By Smart Digital Care.':'சிறந்த மருத்துவ ஒருங்கிணைப்பும் அன்பான வாழ்வும் Smart Digital Care மூலம் இணையும் இல்லம்.','Medication Safety & Management':'மருந்துப் பாதுகாப்பு & மேலாண்மை','Doctor Coordination & Clinical Monitoring':'டாக்டர் ஒருங்கிணைப்பு & மருத்துவ கண்காணிப்பு','Physiotherapy & Rehabilitation':'பிசியோதெரபி & மறுவாழ்வு','Diet & Nutrition Planning':'உணவு & ஊட்டச்சத்து திட்டம்','Family Portal & Daily Updates':'Family Portal & தினசரி தகவல்கள்',
  ...
  function translateHomePage(language){
    ...
    nodes.forEach(function(textNode){
      ...
      const translated=HOME_TRANSLATIONS[clean];
